            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown <#if menu == "watch">active</#if>">
                    ...
                    <ul class="dropdown-menu">
                        <!--<li <#if menu == "loadbalance" && submenu == "random">class="active"</#if>><a href="/lb/random.html">随机</a></li>
                        <li <#if menu == "loadbalance" && submenu == "weight">class="active"</#if>><a href="/lb/weight.html">权重</a></li>-->
